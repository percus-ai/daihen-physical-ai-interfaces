...
class PhiClient:
    ...
    def install_bundled_torch_ws(
        self,
        progress_callback: Optional[Callable[[Dict[str, Any]], None]] = None,
    ) -> Dict[str, Any]:
        """Install existing bundled-torch to current environment via WebSocket.

        This links the already-built bundled-torch without recompilation.
        ...
        try:
            ...
            ws.send(json.dumps({"action": "install"}))
